   ...
   $step=ceil($pagenations/20000);
     ...
     _e('
      ...
      <p> '.__("Please select format type").':</p>
        ...
        <button class="btnxls" id="exportdata" >'.__("Export data").' </button>
...
<p></p>
 <table class=" wp-list-table widefat fixed posts">
      ...
      <thead>
        <tr>
          <th  class="manage-column column-tags"><?php _e("Row" ,"wpxlsdata") ?></th>
          <th  class="manage-column column-tags"><?php _e("Title" ,"wpxlsdata") ?>  </th>
          <th  class="manage-column column-tags"><?php _e("Shortcode" ,"wpxlsdata") ?> </th>
      ...
      <tbody>
          <tr>
            <td  class="author column-author">1</td>
            <td  class="author column-author">Show Data  </td>
            <td  class="author column-author"> [wpxlsdata type="tabel" iddb=<?php echo $id_wpxlsdata ?>] </td>
            <td  class="author column-author">  Show Data in Tabel  </td>
        </tr>
